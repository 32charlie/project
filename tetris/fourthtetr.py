...
class StartScreen:
    def __init__(self):
        ...
        self.button_one = pygame.Rect(245, 560, button_size, button_size)  # Положение кнопки
        self.button_two = pygame.Rect(245, 600, button_size, button_size)  # Положение кнопки
        self.button_three = pygame.Rect(245, 640, button_size, button_size)  # Положение кнопки
        self.buttons = [
            {"text": "1", "rect": pygame.Rect(100, 200, 150, 150), "rect_color": pygame.Rect(102, 202, 146, 146), 'color': (194, 252, 196), "mode": [1, "level_1"]},
            {"text": "2", "rect": pygame.Rect(300, 200, 150, 150), "rect_color": pygame.Rect(302, 202, 146, 146), 'color': (251, 252, 194), "mode": [2, "level_2"]},
            {"text": "3", "rect": pygame.Rect(500, 200, 150, 150), "rect_color": pygame.Rect(502, 202, 146, 146), 'color': (252, 194, 194), "mode": [3, "level_3"]},
            {"text": "Бесконечный режим", "rect": pygame.Rect(200, 400, 350, 150), "rect_color": pygame.Rect(202, 402, 346, 146), 'color': (255, 255, 255), "mode": [1, "infinite"]},
        ]
